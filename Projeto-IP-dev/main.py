...
class Asteroide(object) :
    def __init__(self, categoria):
        ...
        self.w = 50*categoria
        self.h = 50*categoria
        self.ranPoint = random.choice([(random.randrange(0, largura-self.w), random.choice([-1 * self.h - 5, altura+5])),(random.choice([-1*self.w - 5, largura+5]), random.randrange(0, altura-self.h))])
